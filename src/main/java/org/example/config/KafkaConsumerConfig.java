...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, LocationEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "org.example.event");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "org.example.event.LocationEvent");
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        return new DefaultKafkaConsumerFactory<>(
                props,
                new StringDeserializer(),
                new JsonDeserializer<>(LocationEvent.class));
    }
